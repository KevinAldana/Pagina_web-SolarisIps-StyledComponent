...
import{StyledFormWrapper,StyledError,StyledForm,StyledTextArea,StyledInput,StyledFieldset,StyledButton} from './styles/Autorizaciones.styled'
import { InitalState } from './styles/Autorizaciones.styled';
...
function StyledAutorizaciones() {
      ...
      <>
        ...
        <StyledFormWrapper>
          <StyledForm onSubmit={handleSubmit}>
            ...
            <label htmlFor="message">Descripcion de solicitud</label>
            <StyledTextArea
              name="message"
              value={state.message}
              onChange={handleInput}
            ...
            <StyledButton type="submit">Registrar solicitud</StyledButton>
          </StyledForm>
        </StyledFormWrapper>
      </>
    );
  ...
  export default StyledAutorizaciones;